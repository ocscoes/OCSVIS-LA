...
- directamente en el repositorio de Github donde se encuentra alojado el observatorio, mediante fork y pull-request: [https://github.com/jciturras/LAPOP_Iturra-observatorio_cohesion](https://github.com/jciturras/LAPOP_Iturra-observatorio_cohesion)



```{r eval=FALSE, include=FALSE}
rmarkdown::render(input = here::here("home.rmd"),encoding = "UTF-8")
```
